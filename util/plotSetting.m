plotDrawStyle={   struct('color',[1,0,0],'lineStyle','-'),...%red1
    struct('color',[0,1,0],'lineStyle','-'),...%green2
    struct('color',[0,0,1],'lineStyle','-'),...%blue3
    struct('color',[0,0,0],'lineStyle','-'),...%    struct('color',[1,1,0],'lineStyle','-'),...%yellow4
    struct('color',[1,0,1],'lineStyle','-'),...%pink5
